...
MONITOR_RETURN_TYPE_NO_ERR = 0
MONITOR_RETURN_TYPE_LOW = 1
MONITOR_RETURN_TYPE_MEDIUM = 2
MONITOR_RETURN_TYPE_HIGH = 3

MONITOR_COLOR_NO_ERR= ["#00FF00","#808080"]
MONITOR_COLOR_LOW = ["#FFFF00","#FF0000"]
MONITOR_COLOR_MEDIUM = ["#FF8000","#FF0000"]
MONITOR_COLOR_HIGH = ["#FF0000","#FF0000"]
...
class MonitorButia():
    ...
    def __init__(self):
        ...
        self.sensors_name = ['grey', 'light', 'button', 'distanc']
